...
import { ChevronLeft, Video, Phone, MoreVertical, Check, CheckCheck, Play, Mic, Paperclip, Camera, Smile } from 'lucide-react';

const Preview = ({ chatInfo, messages, isDarkMode }) => {
  return (
    <div className={`flex flex-col h-full w-full font-sans select-none overflow-hidden ${isDarkMode ? 'dark bg-[#0b141a]' : 'bg-[#e5ddd5]'}`}>
      ...
      {/* Footer / Input Bar */}
      <div className="px-3 py-2 bg-[#f0f2f5] dark:bg-[#202c33] flex items-center gap-3 shrink-0">
